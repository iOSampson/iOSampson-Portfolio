...
if ( class_exists( 'RyanCVPlugin' ) && class_exists( 'OCDI_Plugin' ) && class_exists( 'ACF' ) ) {
...
function ryancv_ocdi_import_files() {
    ...
    return array(
        ...
        array(
            'import_file_name'             => 'game-developer',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
            'import_file_url'              => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/game-developer/content.xml',
            'import_preview_image_url'     => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/game-developer/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/ryancv-vcard-resume-wordpress-theme/full_screen_preview/22890097',
        ),

        array(
            'import_file_name'             => 'dataops',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
            'import_file_url'              => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/dataops/content.xml',
            'import_preview_image_url'     => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/dataops/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/ryancv-vcard-resume-wordpress-theme/full_screen_preview/22890097',
        ),

        array(
            'import_file_name'             => 'app-developer',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
            'import_file_url'              => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/app-developer/content.xml',
            'import_preview_image_url'     => RYANCV_EXTRA_PLUGINS_DIRECTORY . $extra_dir . '/ocdi-import/demo/app-developer/preview.jpg',
            'preview_url'                  => 'https://1.envato.market/c/1790164/275988/4415?u=https://themeforest.net/item/ryancv-vcard-resume-wordpress-theme/full_screen_preview/22890097',
        ),

        array(
            'import_file_name'             => 'ui-ux-designer',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
        ...
        array(
            'import_file_name'             => 'cybersecurity',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
        ...
        array(
            'import_file_name'             => 'seo-specialist',
            'categories'                   => array( esc_attr__( 'Main', 'ryancv' ) ),
