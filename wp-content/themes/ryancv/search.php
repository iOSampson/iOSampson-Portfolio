...
$blog_grid_gradient = get_field( 'blog_grid_gradient', 'options' );
$blog_grid_skin = get_field( 'blog_grid_skin', 'options' );
...
<div class="card-inner blog animated active" id="card-blog-archive">
	<div class="card-wrap">
		...
		<!--
			Blog
		-->
		<div class="content blog<?php if ( $blog_grid_gradient == 1 ) : ?> styled-gradient<?php endif; ?><?php if ( $blog_grid_skin == 1 ) : ?> blog-style-2<?php endif; ?>">
			<?php if ( have_posts() ) : ?>
				<!-- title -->
				<h1 class="title">
					<?php
